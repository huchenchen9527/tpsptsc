...
window.APP_DATA = {
    ...
    video: [
        ...
        },
        {
            ...
            "tags": ["短片", "电影级写实风格", "人物 / 角色", "建筑 / 室内"],
            "prompt": "超写实电影短片，竖屏 9:16。深夜，一间昏暗而温馨的客厅里，一名幼童坐在木地板上，正小心翼翼地组装一个小玩具项目。在孩子身旁，一个人形机器人单膝跪地，与孩子视线齐平，轻柔地协助处理细小的玩具零件。该机器人拥有逼真的黑白机械躯体、精密的关节结构、细腻的拉丝金属质感、柔和的反光以及富有表现力的机械双眼。动作缓慢、精准且温柔。一束狭窄而富有戏剧性的暖色手电筒光束照亮了孩子的手、玩具以及机器人的手指。清冷的蓝色月光透过附近的窗户洒入室内，营造出冷暖色调之间的绝美对比。自然的人机运动、逼真的手部交互、准确的物体接触、细腻的面部表情、情感真实的叙事、一致的角色外观、物理准确的光影、逼真的阴影与反射、电影级景深、高动态范围、照片级纹理、高端科幻剧情片美学、4K 电影画质。无对白，无字幕，屏幕上无文字。"
        }
    ],
    tools: [
        {
